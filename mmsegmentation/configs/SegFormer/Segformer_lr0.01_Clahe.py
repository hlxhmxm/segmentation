...
custom_hooks = [
    dict(type='SaveAllBetterCheckpointsHook', metric='mIoU', interval=500),
    dict(type='EMeanEntropyHook', dataset='val', interval=500, priority=60)
]
...
work_dir = './work_dirs/Segformer/Segformer_lr0.01_Clahe'
