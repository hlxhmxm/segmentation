# === CONFIGURACIÓN COMPLETA: ENTRENAMIENTO CON VALIDACIÓN USANDO TTA Y MONITOREO DE ENTROPÍA ===

crop_size = (512, 512)
data_root = '/home/maximilianovelez/00_openmmlab_respaldo/_aanalizando/automine1d/'
...
# Nuevo: hook personalizado para calcular entropía promedio durante validación
custom_hooks = [
    dict(
        type='SaveAllBetterCheckpointsHook',
        metric='mIoU',
        interval=500
    ),
    dict(
        type='EMeanEntropyHook',
        dataset='val',
        interval=500,
        priority=60
    )
...
custom_imports = dict(
    imports=[
        'mmseg.engine.hooks.save_all_better_checkpoints_hook',
        'mmseg.engine.hooks.emean_entropy_hook',
...
work_dir = './work_dirs/Mobilnet/Mobilnet_lr0.001_Clahe'
